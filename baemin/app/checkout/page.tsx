...
export default function Home() {
    ...
    const onOrder = () => {
        // call API post pay order
        try {
            fetch(`http://localhost:8080/orders/pay/${searchParams?.get('id')}`, {
                method: 'POST',
                headers: {
        ...
        <>
            ...
            <div className="px-16 flex flex-col gap-3 ">'
                ...
                <div className="w-full bg-white rounded-md  flex flex-col pt-5 ">
                    ...
                    <DetailsCheckout items={localStorage.getItem('cart') ? JSON.parse(localStorage.getItem('cart') || '') : []} />
                ...
                <div className="w-full  flex flex-col bg-white rounded-md  pt-5 gap-3">
                    ...
                    <div className="w-full border-t  flex flex-row justify-between items-center  pt-4  gap-4 mb-4">
                        ...
                        <div className="w-[30%] pl-48 ">
                            <button onClick={onOrder} className="p-1 bg-beamin text-white w-36 rounded-md h-10 hover:brightness-105">
                                Đặt hàng
                            </button>
                        </div>
                    </div>
